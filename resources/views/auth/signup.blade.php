          ...
          <div class="col-xl-5 col-lg-7">
            <div class="account-card">
              ...
              <div class="account-card__body">
                <form action="{{ route('createuser') }}" class="mt-4" method="post">
                  @csrf
                  ...
                  <div class="form-group">
                    <label>Mobile</label>
                      <input type="text" name="mobile" class="form-control" value="{{ old('mobile') }}" placeholder="Your Phone Number" >
                    @error('mobile')
				    	<div class="text-danger" style="font-size: 14px;">{{ $message }}</div>
					@enderror
                  </div>
                  ...
                  <div class="form-row mt-2">
                    <div class="col-md-12">
                      <input type="checkbox" name="terms"> <span class="f-size-14 ml-2">I agree with
                        <a class="base--color" href=""> Privacy &amp; Policy</a>
                        ,
                        <a class="base--color" href=""> Terms &amp; Condition</a>
                      </span>
                    </div>
                  </div>
                  <div class="mt-3">
